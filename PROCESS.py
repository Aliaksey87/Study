...
if __name__ == "__main__":
    example1()
    # run([[create_random_list, (1, 101), {}]])


# 1. Используя исходный код из примера (убрать вызов example1):
# 1.1 написать функцию которая принимает список целых чисел (от 1 до 100) и считает для каждого числа факториал (math.factorial).
